...
class MFS_DeleteService(unittest.TestCase):
    def setUp(self):
    ...
    def test_deleteservice(self):
        ...
        elem = driver.find_element_by_xpath('//*[@id="content-main"]/div[2]/table/tbody/tr[3]/th/a')
        driver.get_screenshot_as_file(
            "C:\\Users\\devan\\8210 Projects\\MFS test scripts\\screenshots\\DeleteServicesPortal.png")
        elem.click()
        time.sleep(3)
        ...
        elem.click()
        driver.get_screenshot_as_file(
            "C:\\Users\\devan\\8210 Projects\\MFS test scripts\\screenshots\\DeleteSelectedServices.png")
        time.sleep(3)
        ...
        elem.click()
        driver.get_screenshot_as_file(
            "C:\\Users\\devan\\8210 Projects\\MFS test scripts\\screenshots\\SelectDeleteServices.png")
        time.sleep(1)
        ...
        driver.get_screenshot_as_file(
            "C:\\Users\\devan\\8210 Projects\\MFS test scripts\\screenshots\\DeleteSelectedServicesConfirmation.png")
        elem.submit()
        time.sleep(3)
        driver.get_screenshot_as_file(
            "C:\\Users\\devan\\8210 Projects\\MFS test scripts\\screenshots\\DeletedServiceList.png")
        time.sleep(2)
